...
public class TelaSoma extends javax.swing.JFrame {
    ...
    private void btnSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSomaActionPerformed
        ...
        int n1 = Integer.parseInt(txtN1.getText()); //comando com conversão de string (texto) pra inteiro
        int n2 = Integer.parseInt(txtN1.getText());
        
        int s = n1 + n2; //faz a soma de n1 e n2 e salva na var s
        
        lblSoma.setText(Integer.toString(s)); //converte de int p string
